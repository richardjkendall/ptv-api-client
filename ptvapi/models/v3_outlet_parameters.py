...
class V3OutletParameters(object):
    ...
    def __init__(self, max_results=None):  # noqa: E501
        """V3OutletParameters - a model defined in Swagger"""  # noqa: E501
    ...
    def max_results(self):
        """Gets the max_results of this V3OutletParameters.  # noqa: E501

        Maximum number of results returned (default = 30)  # noqa: E501

        :return: The max_results of this V3OutletParameters.  # noqa: E501
        :rtype: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V3OutletParameters, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V3OutletParameters):
            return False
