...
class V3OutletGeolocationParameters(object):
    ...
    def __init__(self, max_distance=None, max_results=None):  # noqa: E501
        """V3OutletGeolocationParameters - a model defined in Swagger"""  # noqa: E501
    ...
    def max_distance(self):
        """Gets the max_distance of this V3OutletGeolocationParameters.  # noqa: E501

        Filter by maximum distance (in metres) from location specified via latitude and longitude parameters (default = 300)  # noqa: E501

        :return: The max_distance of this V3OutletGeolocationParameters.  # noqa: E501
        :rtype: float
        """
    ...
    def max_results(self):
        """Gets the max_results of this V3OutletGeolocationParameters.  # noqa: E501

        Maximum number of results returned (default = 30)  # noqa: E501

        :return: The max_results of this V3OutletGeolocationParameters.  # noqa: E501
        :rtype: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V3OutletGeolocationParameters, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V3OutletGeolocationParameters):
            return False
