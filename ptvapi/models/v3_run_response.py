...
class V3RunResponse(object):
    ...
    def __init__(self, run=None, status=None):  # noqa: E501
        """V3RunResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def run(self):
        """Gets the run of this V3RunResponse.  # noqa: E501

        Individual trip/service of a route  # noqa: E501

        :return: The run of this V3RunResponse.  # noqa: E501
        :rtype: V3Run
        """
        return self._run
    ...
    @property
    def status(self):
        """Gets the status of this V3RunResponse.  # noqa: E501

        API Status / Metadata  # noqa: E501

        :return: The status of this V3RunResponse.  # noqa: E501
        :rtype: V3Status
        """
        return self._status
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V3RunResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V3RunResponse):
            return False
