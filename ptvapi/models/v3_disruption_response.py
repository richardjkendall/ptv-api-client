...
class V3DisruptionResponse(object):
    ...
    def __init__(self, disruption=None, status=None):  # noqa: E501
        """V3DisruptionResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def disruption(self):
        """Gets the disruption of this V3DisruptionResponse.  # noqa: E501

        Disruption information applicable to relevant routes or stops  # noqa: E501

        :return: The disruption of this V3DisruptionResponse.  # noqa: E501
        :rtype: V3Disruption
        """
    ...
    @property
    def status(self):
        """Gets the status of this V3DisruptionResponse.  # noqa: E501

        API Status / Metadata  # noqa: E501

        :return: The status of this V3DisruptionResponse.  # noqa: E501
        :rtype: V3Status
        """
        return self._status
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V3DisruptionResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V3DisruptionResponse):
            return False
