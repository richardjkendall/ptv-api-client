...
class V3ResultStop(object):
    ...
    def __init__(self, stop_distance=None, stop_suburb=None, stop_name=None, stop_id=None, route_type=None, stop_latitude=None, stop_longitude=None, stop_sequence=None):  # noqa: E501
