...
class V3ErrorResponse(object):
    ...
    def __init__(self, message=None, status=None):  # noqa: E501
        """V3ErrorResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def message(self):
        """Gets the message of this V3ErrorResponse.  # noqa: E501

        Error message  # noqa: E501

        :return: The message of this V3ErrorResponse.  # noqa: E501
        :rtype: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this V3ErrorResponse.  # noqa: E501

        API Status / Metadata  # noqa: E501

        :return: The status of this V3ErrorResponse.  # noqa: E501
        :rtype: V3Status
        """
        return self._status
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V3ErrorResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V3ErrorResponse):
            return False
