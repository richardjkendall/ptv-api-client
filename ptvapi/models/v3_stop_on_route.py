...
class V3StopOnRoute(object):
    ...
    def __init__(self, disruption_ids=None, stop_suburb=None, stop_name=None, stop_id=None, route_type=None, stop_latitude=None, stop_longitude=None, stop_sequence=None):  # noqa: E501
