...
class PatternsApi(object):
    ...
    def patterns_get_pattern_by_run(self, run_id, route_type, expand, **kwargs):  # noqa: E501
        """View the stopping pattern for a specific trip/service run  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patterns_get_pattern_by_run(run_id, route_type, expand, async_req=True)
        >>> result = thread.get()
        ...
        :param list[str] expand: Objects to be returned in full (i.e. expanded) - options include: all, stop, route, run, direction, disruption. By default disruptions are expanded. (required)
        ...
        if kwargs.get('async_req'):
            return self.patterns_get_pattern_by_run_with_http_info(run_id, route_type, expand, **kwargs)  # noqa: E501
        else:
            (data) = self.patterns_get_pattern_by_run_with_http_info(run_id, route_type, expand, **kwargs)  # noqa: E501
            return data

    def patterns_get_pattern_by_run_with_http_info(self, run_id, route_type, expand, **kwargs):  # noqa: E501
        """View the stopping pattern for a specific trip/service run  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patterns_get_pattern_by_run_with_http_info(run_id, route_type, expand, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['run_id', 'route_type', 'expand', 'stop_id', 'date_utc', 'token', 'devid', 'signature']  # noqa: E501
        ...
        if ('run_id' not in params or
            ...
            raise ValueError("Missing the required parameter `run_id` when calling `patterns_get_pattern_by_run`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v3/pattern/run/{run_id}/route_type/{route_type}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
