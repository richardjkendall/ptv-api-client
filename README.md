...
api_instance = ptvapi.DeparturesApi(ptvapi.ApiClient(configuration))
...
*PatternsApi* | [**patterns_get_pattern_by_run**](docs/PatternsApi.md#patterns_get_pattern_by_run) | **GET** /v3/pattern/run/{run_id}/route_type/{route_type} | View the stopping pattern for a specific trip/service run
...
*RunsApi* | [**runs_for_run**](docs/RunsApi.md#runs_for_run) | **GET** /v3/runs/{run_id} | View all trip/service runs for a specific run ID
*RunsApi* | [**runs_for_run_and_route_type**](docs/RunsApi.md#runs_for_run_and_route_type) | **GET** /v3/runs/{run_id}/route_type/{route_type} | View the trip/service run for a specific run ID and route type
